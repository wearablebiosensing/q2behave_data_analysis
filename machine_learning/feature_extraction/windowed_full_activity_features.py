...
def run_sctivity_based_windowing(folder_path):
    ...
    for filename in files_without_ds_store:
       ...
       # 'Second Hyperactive Behaviour Type ', 'new_zeroTS'],
            ...
            # ####################################
            Fs = average_sampling_rate(df)
            wind_size = int(Fs*6) # 2 seconds worth of data, and 1 second.
...
folder_path = root + "Synced_Files_All_New"
...
df_stat_features.to_csv(root + "CodeOutputs/2026/Windowing_Features/stat_features_six_second.csv")
# print('It took', time.time()-start, 'seconds to calcualte PSD features.')
df_feature.to_csv(root + "CodeOutputs/2026/Windowing_Features/psd_features_six_second_P.csv")
all_features_df.to_csv(root+ "CodeOutputs2026/Windowing_Features/all_features_six_second_P5.csv")
...
# df_stat_features.to_csv("/Users/shehjarsadhu/Desktop/UniversityOfRhodeIsland/Graduate/WBL/Project_Q2Behave/CodeOutputs/Windowing_Features/stat_features_six_second_P5.csv")
# # print('It took', time.time()-start, 'seconds to calcualte PSD features.')
# df_feature.to_csv("/Users/shehjarsadhu/Desktop/UniversityOfRhodeIsland/Graduate/WBL/Project_Q2Behave/CodeOutputs/Windowing_Features/psd_features_six_second_P.csv")
# all_features_df.to_csv("/Users/shehjarsadhu/Desktop/UniversityOfRhodeIsland/Graduate/WBL/Project_Q2Behave/CodeOutputs/Windowing_Features/all_features_six_second_P5.csv")