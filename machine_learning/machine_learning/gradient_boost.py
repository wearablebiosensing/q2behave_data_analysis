...
# import neptunecontrib.api.utils as npt_utils
# from neptunecontrib.api.utils import get_filepaths
from sklearn.metrics import roc_curve, auc
from sklearn.metrics import roc_auc_score
from sklearn.utils import resample
# import neptunecontrib.monitoring.utils as npt_utils
from sklearn.metrics import accuracy_score
...
def gb_cross_validation_with_cm(dataframe, test_size, pid, tag):
    ...
    # Define a pipeline with Gradient Boosting Classifier
    pipeline = Pipeline([
    ...
    for folds in [2, 3]:
        run = neptune.init_run(
            project="shehjar/ADHD-SVM",    api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiJlMGQxM2Q4ZC00ODE4LTRhNDMtYWY1Yy1kMGIzZTI5MzcxMzUifQ==",
            name=str(folds) + "-Fold" + "test_size_" + str(test_size) + "_GB"  # Set your custom run name here
        )
        run["pid"] = str(pid)
