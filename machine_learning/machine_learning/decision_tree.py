...
def dt_cross_validation_with_cm(dataframe, test_size, pid, tag):
    ...
    # Define a pipeline with Decision Tree
    pipeline = Pipeline([
    ...
    for folds in [2, 5]:
        run = neptune.init_run(
            ...
            name=str(folds) + "-Fold" + "test_size_" + str(test_size) + "_DT"  # Set your custom run name here
        )
        run["pid"] = str(pid)
