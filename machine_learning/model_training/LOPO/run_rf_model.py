from ml_random_forest import rf_leave_one_participant_out_weighted
...
def select_feature_dataframe():
    """
    Opens file dialog to select PSD windowed feature table.
    """
...
# Rename BehaviorCode → type (RF expects 'type')
...
print("Class Distribution:", df_raw["type"].value_counts())

# ==========================================================
# 3. Run LOPO Random Forest
# ==========================================================
